...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    detail: function detail(id) {
      ...
      _app__WEBPACK_IMPORTED_MODULE_1__["bus"].$emit('detail', this.mail); // console.log(id);
    }
  },
        ...
        _c("div", { staticClass: "card card-default" }, [
          ...
          _c("div", { staticClass: "card-body" }, [
            _c(
              ...
              [
                _c("datetime", {
                  attrs: { format: "YYYY/MM/DD", width: "200px" },
                  model: {
                    value: _vm.from_date,
                    callback: function($$v) {
                      _vm.from_date = $$v
                  ...
                  return _c(
                    ...
                    [
                      _c("td", [
                        _vm._v(
                          "\n                              " +
                            _vm._s(mail.from_email) +
                            "\n                            "
                        )
                      ]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(mail.body_cut))]),
                      _vm._v(" "),
                      ...
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(_vm.moment(mail.send_date).fromNow()))
                      ])
                    ]
                  )
                })
